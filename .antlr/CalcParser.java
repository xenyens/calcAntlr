...
public class CalcParser extends Parser {
	...
	public static class AsignacionContext extends InstruccionesContext {
		...
		public AsignacionContext(InstruccionesContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class EvaluacionContext extends InstruccionesContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public EvaluacionContext(InstruccionesContext ctx) { copyFrom(ctx); }
	}
	...
	public final InstruccionesContext instrucciones() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new EvaluacionContext(_localctx);
